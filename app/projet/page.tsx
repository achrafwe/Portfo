                ...
                <div className="flex flex-col xl:flex-row xl:gap-[30px]">
                    <div
                        ...
                        <div className="flex flex-col gap-[30px] h-[50px]">
                            <div
                                className="text-8xl leading-none font-extrabold text-transparent text-outline">{projet.num}
                            </div>
                            <h2 className="text-[42px] font font-bold leading-none text-white group-hover:text-accent
                            ...
                            <ul className='flex gap-4'>
                                {projet.stack.map((item, index) => {
                                    return <li key={index}
                                               className="text-xl text-accent"> {item.name}{index !== projet.stack.length - 1 ? "," : ""}
                                    </li>
                                })}
                            </ul>
                    ...
                    <div className="w-full xl:w-[50%]">
                        <Swiper spaceBetween={30} slidesPerView={1} className="xl:h-[520px] mb-12"
                                onSlideChange={handleSlideChange}>{projets.map((projet, index) => {
